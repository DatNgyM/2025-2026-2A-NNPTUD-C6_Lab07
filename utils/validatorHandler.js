...
module.exports = {
    ...
    /** Doi mat khau: newpassword cung rule manh nhu dang ky */
    ChangePasswordValidator: [
        body('oldpassword').notEmpty().withMessage('oldpassword khong duoc de trong'),
        body('newpassword').isStrongPassword(options.password).withMessage(
            `newpassword: toi thieu ${options.password.minLength} ky tu, co ${options.password.minNumbers} so, ${options.password.minUppercase} chu hoa, ${options.password.minLowercase} chu thuong, ${options.password.minSymbols} ky tu dac biet`
        ),
    ],
